...
/*   Updated: 2020/01/05 14:57:05 by tgouedar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static inline struct s_btree	*two_children_case(struct s_btree *root,
													void (*del)(void *))
{
...
static inline struct s_btree	*delete_node(struct s_btree *root,
													void (*del)(void *))
{
	struct s_btree	*node;
...
static struct s_btree			*find_node(struct s_btree *root, void *data_ref,
...
void							bstree_remove_data(struct s_btree **root,
			void *data_ref, int (*cmpf)(void *, void *), void (*del)(void *))
{
	if (*root)
